...
def get_start_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="➕ Add to Group", url="http://t.me/python_boss_robot?startgroup=start")],
            [InlineKeyboardButton(text="📢 Join Updates Channel", url="https://t.me/pythonNews_Uzbekistan")]
        ]
    )
